...
// ── GET /api/emploi/jobs ──────────────────────────────────────────────────────
// FIX (moteur de recherche) : support du multi-valeurs pour contractType et
// remote (ex: ?contractType=CDI,CDD&remote=full,partial), séparés par virgule
// côté client via .join(','). Une seule valeur reste 100% rétro-compatible.
