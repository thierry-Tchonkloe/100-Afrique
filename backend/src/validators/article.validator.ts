...
export const quickCreateArticleSchema = z.object({
  body: z.object({
    ...
    // ✅ CORRECTIF — sans ce champ, Zod supprimait silencieusement
    // destinationId envoyé par les modals de création rapide
    // (Newarticlemodal.tsx / Newvideomodal.tsx), empêchant toute
    // association dès la création.
