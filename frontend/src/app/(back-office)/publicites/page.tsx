            ...
            <section>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    >
                        ...
                        {/* FIX : slug visible + copiable, pour vérifier en un coup d'œil qu'il
                        correspond bien au zoneSlug codé en dur côté front (TopBar.tsx, 
                        page.tsx → "top-banner-accueils", "leaderboards-footer") */}
                        <button
                            type="button"
                            onClick={(e) => {
                            e.stopPropagation();
                            navigator.clipboard.writeText(zone.slug);
                            }}
