...
export default async function HomePage() {
  const [magazines, videos, salons, destinations] = await Promise.all([
    getHomeMagazines(),
    getHomeVideos(),
    getHomeSalons(),
    getHomeDestinations(),
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow">
        <div className="space-y-0">
          <HeroSlider magazines={magazines} />
          <NewsSection magazines={magazines} />
          <VideoSection videos={videos} />
          <EventsDestinationsSection salons={salons} destinations={destinations} />
          <ContactCTASection />
        </div>
