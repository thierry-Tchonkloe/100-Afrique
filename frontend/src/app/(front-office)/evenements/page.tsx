...
//             {/* Titre : texte courant sur fond blanc → text-it-blue */}
//             <h1 className="text-it-blue text-4xl md:text-5xl font-serif font-bold uppercase tracking-tight leading-tight">
...
//               {/* Accent → text-it-gold */}
//               <Loader2 className="animate-spin text-it-gold" size={40} />
//             </div>
//           ) : (
...
//           <div className="bg-it-gray-light w-full flex items-center justify-center rounded-sm border border-gray-100 text-center">
//             <AdvertisingBanner
...
//               {/* Titre section → text-it-blue */}
//               <h4 className="text-it-blue font-serif font-bold text-sm uppercase">
//                 Interview Exclusive
//               </h4>
//               <Link
...
//                   {/* Bouton play → CTA → bg-it-terracotta */}
//                   <div className="w-10 h-10 bg-it-terracotta rounded-full flex items-center justify-center text-white shadow-lg group-hover:scale-110 transition-transform">
//                     <Play size={16} fill="white" />
//                   </div>
//                 </div>
//               </Link>
//               <p className="text-it-blue text-xs font-bold leading-snug line-clamp-2">
//                 {interview.title}
//               </p>
//               <p className="text-gray-400 text-[10px]">
//                 Par {interview.author?.name ?? 'Rédaction'}
//               </p>
//               {/* CTA → bg-it-terracotta / hover bg-it-terracotta-dark */}
//               <Link
//                 href={`/actualites/${interview.slug}`}
//                 className="w-full bg-it-terracotta text-white py-3 rounded-lg flex items-center justify-center gap-2 text-xs font-bold hover:bg-it-terracotta-dark transition-colors"
//               >
...
//           <div className="bg-it-emerald-dark rounded-xl p-8 text-white shadow-xl">
...
//                   className="w-full px-4 py-3 bg-white rounded-md text-gray-900 text-sm outline-none focus:ring-2 focus:ring-it-gold disabled:opacity-50"
//                 />
//                 {/* CTA bouton → bg-it-terracotta / hover bg-white text-it-emerald-dark */}
//                 <button
//                   type="submit"
//                   disabled={newsletterStatus === 'loading'}
//                   className="w-full bg-it-terracotta py-3 rounded-md text-xs font-bold uppercase tracking-widest hover:bg-white hover:text-it-emerald-dark transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
//                 >
