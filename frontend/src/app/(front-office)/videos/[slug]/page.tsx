...
// ─── Content Renderer (texte d'accompagnement) ────────────────────────────────

const ContentRenderer = ({ blocks }: { blocks: ContentBlock[] }) => {
    // On exclut les blocs vidéo — déjà rendus dans le player principal
    ...
    return (
        ...
        {textBlocks.map((block, index) => {
            ...
            case 'heading':
                ...
                <h2
                    key={index}
                    className="text-2xl md:text-3xl font-bold text-[#163066] mt-10 mb-4 leading-snug"
                >
                    {block.value}
                </h2>
                );
...
const VideoDetailPage = () => {
    ...
    useEffect(() => {
        ...
        try {
            ...
            // Vidéos similaires de la même catégorie
            try {
    ...
    return (
        ...
        <div className="max-w-5xl mx-auto px-4 md:px-8 py-10">
            ...
            <div className="flex items-center gap-2">
                ...
                <span>
                Par <strong className="text-[#163066]">{video.author.name}</strong>
                </span>
            </div>
            <div className="flex items-center gap-2">
