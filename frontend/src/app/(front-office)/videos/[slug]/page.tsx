...
import { ArrowLeft, Clock, Eye, Calendar, Tag, User, ExternalLink, Loader2, Play } from 'lucide-react';
import {
  SocialFacette, SocialEnvol, SocialNoeud,
  WaveMark,
    ...
    return (
      <div className="space-y-4">
        ...
        <div className="flex justify-center">
          {/* Lien externe → accent → text-it-gold */}
          <a
        ...
        {video.destination && (
          ...
          <div className="mt-6 p-5 bg-it-blue/5 rounded-2xl flex items-center justify-between">
            <div>
              ...
              <p className="text-it-blue font-bold text-lg">{video.destination.name}</p>
            </div>
            {/* CTA → bg-it-emerald-dark / hover bg-it-terracotta */}
            <Link
...
//                                        opacity-0 scale-95 transition-all duration-200
//                                        group-hover/social:opacity-100 group-hover/social:scale-100"
//                             style={{ background: '#163066', color: '#ffffff' }}
//                         >
//                             {label}
//                         </span>
//                     </div>
