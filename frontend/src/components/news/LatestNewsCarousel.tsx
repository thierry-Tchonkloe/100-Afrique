      ...
      <div className={`relative transition-opacity duration-200 ${pageLoading ? 'opacity-40 pointer-events-none' : 'opacity-100'}`}>
        {pageLoading && (
          <div className="absolute inset-0 flex items-center justify-center z-10">
            <Loader2 className="animate-spin" size={28} style={{ color: '#1A5C43' }} />
          </div>
        )}
          ...
          {magazines.map((mag) => (
            ...
            >
              ...
              <div className="p-3 sm:p-4 flex flex-col flex-1">
                <h3
                  className="font-bold text-[13px] sm:text-[14px] leading-snug mb-2 line-clamp-2 flex-1 transition-colors"
                  style={{ color: '#001A4D' }}
