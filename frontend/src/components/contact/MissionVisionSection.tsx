...
//   // Récupération des statistiques réelles via l'API
//   useEffect(() => {
//     const fetchStats = async () => {
//       try {
//         const response = await api.get('/about/stats');
...
//         {/* --- TITRE DE LA SECTION --- */}
//         <h2 className="text-3xl md:text-4xl font-serif font-bold text-[#163066] text-center uppercase mb-12">
//           Notre Mission et Notre Vision
//         </h2>

//         {/* --- BLOC DE TEXTE AVEC BORDURE ORANGE --- */}
//         <div className="bg-[#F8FAFC] rounded-r-xl border-l-4 border-[#F19300] p-8 md:p-12 mb-16 shadow-sm">
//           <div className="space-y-6 text-gray-700 leading-relaxed text-sm md:text-base">
//             <p>
//               Créé pour valoriser les destinations africaines et informer les professionnels du tourisme, WAXÉHO et i Tourisme TV forment un duo complémentaire unique dans le paysage médiatique touristique francophone.
//             </p>
...
//             <p>
//               <span className="font-bold text-[#163066]">WAXEHO</span>, magazine digital et expertise éditoriale, offre des analyses approfondies, des reportages exclusifs et une couverture complète de l&apos;actualité touristique africaine et internationale. Notre équipe de journalistes spécialisés décrypte les tendances, met en lumière les innovations et accompagne les acteurs du secteur.
//             </p>
            
//             <p>
//               <span className="font-bold text-[#163066]">iTourisme TV</span>, plateforme vidéo et reportages immersifs, donne vie aux destinations à travers des documentaires, interviews et contenus visuels captivants. Nous créons des ponts entre les cultures et inspirons les voyageurs du monde entier.
//             </p>
//           </div>
//         </div>
...
//         <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
//           {/* Lecteurs Mensuels */}
//           <div className="bg-[#F8FAFC] rounded-xl p-8 text-center transition-transform hover:scale-105">
//             <span className="block text-4xl font-serif font-bold text-[#F19300] mb-2">
