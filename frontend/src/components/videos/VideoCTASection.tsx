  ...
  return (
    <section className="py-16 px-6 bg-white">
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row bg-it-emerald-dark rounded-xl overflow-hidden shadow-2xl min-h-[400px]">
          ...
          <div className="w-full md:w-1/2 p-10 md:p-16 flex flex-col justify-center items-start space-y-6">
            ...
            <button
              ...
              className="flex items-center gap-3 bg-it-terracotta hover:bg-it-terracotta-dark text-white font-bold px-8 py-4 rounded-lg transition-all active:scale-95 shadow-lg group"
            >
