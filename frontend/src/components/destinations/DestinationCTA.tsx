...
// import { LiaisonMark } from '@/components/icons/CustomIcons';
...
//         >
//           {/* Icône — LiaisonMark remplace Handshake */}
//           <div
...
//             style={{ color: '#C8A84B', transitionDelay: '150ms', opacity: visible ? 1 : 0, transform: visible ? 'translateY(0)' : 'translateY(14px)' }}
//           >
...
//             style={{ letterSpacing: '-0.01em', transitionDelay: '250ms', opacity: visible ? 1 : 0, transform: visible ? 'translateY(0)' : 'translateY(20px)' }}
//           >
...
//             style={{ transitionDelay: '330ms', opacity: visible ? 1 : 0, transform: visible ? 'translateY(0)' : 'translateY(16px)' }}
//           >
...
//             style={{ transitionDelay: '420ms', opacity: visible ? 1 : 0, transform: visible ? 'translateY(0)' : 'translateY(14px)' }}
//           >
//             <button
