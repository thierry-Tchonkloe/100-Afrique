...
// // Interface pour le typage de la réponse d'erreur API
// interface ApiErrorData {
//   message?: string;
// }
...
//             <>
//               <div className="flex items-center gap-4 mb-6">
//                 <div className="w-14 h-14 bg-it-orange/10 rounded-full flex items-center justify-center text-it-orange shrink-0">
//                   <Video size={32} fill="currentColor" />
//                 </div>
//                 <div>
//                   <h2 className="text-xl font-bold text-it-orange uppercase tracking-wide">
//                     Demande de Devis
//                   </h2>
//                   <p className="text-xs text-gray-500 mt-1 leading-relaxed">
//                     Décrivez votre besoin pour une interview, un reportage ou un format sur mesure par i Tourisme TV.
...
//               <div className="bg-[#FFF8F0] border-l-4 border-it-orange p-3 mb-8 flex items-center gap-3">
//                 <span className="text-it-orange">★</span>
//                 <p className="text-[11px] font-bold text-[#D98E1F]">
//                   Accédez à une audience professionnelle et ciblée via notre plateforme vidéo.
//                 </p>
//               </div>
...
//                     Quel type de format recherchez-vous ? <span className="text-red-500">*</span>
//                   </label>
//                   <select required name="format" className="w-full bg-white border border-gray-300 rounded-md px-4 py-2.5 text-sm focus:border-it-orange outline-none transition-all appearance-none bg-[url('data:image/svg+xml;charset=US-ASCII,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%2224%22%20height%3D%2224%22%20viewBox%3D%220%200%2024%2024%22%20fill%3D%22none%22%20stroke%3D%22%239ca3af%22%20stroke-width%3D%222%22%20stroke-linecap%3D%22round%22%20stroke-linejoin%3D%22round%22%3E%3Cpath%20d%3D%22M6%209l6%206%206-6%22%2F%3E%3C%2Fsvg%3E')] bg-[length:20px] bg-[right_10px_center] bg-no-repeat">
//                     <option value="">Sélectionnez un format</option>
//                     <option value="interview">Interview</option>
//                     <option value="reportage">Reportage</option>
//                     <option value="mesure">Format sur mesure</option>
...
//                     Thème ou Sujet de votre reportage <span className="text-red-500">*</span>
//                   </label>
//                   <input required name="theme" type="text" placeholder="Ex: Promotion du patrimoine culturel" className="w-full border border-gray-300 rounded-md px-4 py-2.5 text-sm focus:border-it-orange outline-none" />
//                 </div>
...
//                     Où le tournage doit-il avoir lieu ? <span className="text-red-500">*</span>
//                   </label>
//                   <input required name="location" type="text" placeholder="Ex: IFTM Paris, vos locaux, etc." className="w-full border border-gray-300 rounded-md px-4 py-2.5 text-sm focus:border-it-orange outline-none" />
//                 </div>
...
//                     Durée approximative souhaitée <span className="text-red-500">*</span>
//                   </label>
//                   <select required name="duration" className="w-full border border-gray-300 rounded-md px-4 py-2.5 text-sm focus:border-it-orange outline-none appearance-none bg-[url('data:image/svg+xml;charset=US-ASCII,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%2224%22%20height%3D%2224%22%20viewBox%3D%220%200%2024%2024%22%20fill%3D%22none%22%20stroke%3D%22%239ca3af%22%20stroke-width%3D%222%22%20stroke-linecap%3D%22round%22%20stroke-linejoin%3D%22round%22%3E%3Cpath%20d%3D%22M6%209l6%206%206-6%22%2F%3E%3C%2Fsvg%3E')] bg-[length:20px] bg-[right_10px_center] bg-no-repeat">
//                     <option value="">Sélectionnez une durée</option>
//                     <option value="1-3min">1 à 3 minutes</option>
//                     <option value="3-5min">3 à 5 minutes</option>
//                     <option value="plus">Plus de 5 minutes</option>
...
//                   <div>
//                     <label className="block text-[11px] font-bold text-gray-700 mb-1.5">Prénom <span className="text-red-500">*</span></label>
//                     <input required name="firstname" type="text" className="w-full border border-gray-300 rounded-md px-4 py-2.5 text-sm focus:border-it-orange outline-none" />
//                   </div>
//                   <div>
//                     <label className="block text-[11px] font-bold text-gray-700 mb-1.5">Nom <span className="text-red-500">*</span></label>
//                     <input required name="lastname" type="text" className="w-full border border-gray-300 rounded-md px-4 py-2.5 text-sm focus:border-it-orange outline-none" />
//                   </div>
//                 </div>

//                 <div>
//                   <label className="block text-[11px] font-bold text-gray-700 mb-1.5">Organisation <span className="text-red-500">*</span></label>
//                   <input required name="organization" type="text" className="w-full border border-gray-300 rounded-md px-4 py-2.5 text-sm focus:border-it-orange outline-none" />
//                 </div>

//                 <div>
//                   <label className="block text-[11px] font-bold text-gray-700 mb-1.5">Email Professionnel <span className="text-red-500">*</span></label>
//                   <input required name="email" type="email" className="w-full border border-gray-300 rounded-md px-4 py-2.5 text-sm focus:border-it-orange outline-none" />
//                 </div>

//                 <div>
//                   <label className="block text-[11px] font-bold text-gray-700 mb-1.5">Budget estimé (Optionnel)</label>
//                   <textarea name="budget" rows={3} placeholder="Précisez votre budget ou vos contraintes..." className="w-full border border-gray-300 rounded-md px-4 py-2.5 text-sm focus:border-it-orange outline-none resize-none" />
//                 </div>

//                 <button 
//                   disabled={loading}
//                   type="submit" 
//                   className="w-full bg-it-orange text-white font-bold py-3.5 rounded-md flex items-center justify-center gap-3 hover:bg-[#e69b2d] transition-all shadow-md active:scale-[0.98] disabled:opacity-70"
//                 >
//                   {loading ? <Loader2 className="animate-spin" size={20} /> : <Send size={16} fill="white" />}
//                   <span className="text-sm uppercase tracking-wider">Demander mon Devis Vidéo</span>
//                 </button>
...
//                 <div className="text-center pt-2">
//                   <p className="text-[10px] text-gray-400 mb-2">Ou contactez-nous directement</p>
//                   <a href="https://wa.me/votre_numero" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-2 w-full text-it-orange text-xs font-bold hover:underline">
//                     <MessageCircle size={18} />
//                     Studio i Tourisme TV via WhatsApp
//                   </a>
//                 </div>
...
//                 Merci ! Notre équipe étudie votre projet et vous contactera sous 48h.
//               </p>
//               <button onClick={handleClose} className="bg-it-blue text-white px-8 py-2 rounded-full font-bold transition-all text-sm uppercase tracking-widest hover:bg-it-orange">
//                 Fermer
//               </button>
//             </div>
//           )}
