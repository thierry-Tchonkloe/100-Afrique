...
// // ─── Helper : obtenir le slug secteur depuis le label de catégorie ─────────
// //
// // megaMenuData[category].slug correspond déjà au slug de catégorie API (ex: "hotellerie").
// // On l'utilise directement pour construire le lien /secteurs/[slug].
...
//                     {/*
//                       ── MODIFICATION : "Voir tous" redirige vers /secteurs/[slug]
//                          au lieu de /actualites générique.
//                          On utilise activeSlug (= megaMenuData[activeMenu].slug)
//                          qui correspond directement au slug de la page secteur.
//                     */}
//                     <Link
//                       href={activeSlug ? `/secteurs/${activeSlug}` : '/actualites'}
...
//                         {/* Magazines + lien "Voir tous" vers /secteurs/[slug] */}
//                         <div className="flex items-center justify-between mb-3">
...
//                           </p>
//                           {/*
//                             ── MODIFICATION mobile : "Voir tous" → /secteurs/[slug]
//                                data.slug est le même slug utilisé pour le fetch API,
//                                on l'utilise pour pointer vers la page secteur dédiée.
//                           */}
//                           <Link
//                             href={`/secteurs/${slug}`}
