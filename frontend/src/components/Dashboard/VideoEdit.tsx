...
// import { X, Save, Globe, Calendar, Clock, Image as ImageIcon, ChevronDown, Play, Plus, Loader2, AlertCircle, CheckCircle2,} from "lucide-react";
...
// function TagBadge({ tag, onRemove }: { tag: VideoTag; onRemove: (id: string) => void }) {
//     return (
//         <span
...
//         >
//         {tag.label}
//         <button onClick={() => onRemove(tag.id)} className="hover:opacity-70 transition-opacity">
//             <X className="w-3 h-3" />
//         </button>
//         </span>
//     );
...
//         sourceUrl:   video.coverImage ?? "",
//         duration:    "",
//         status:      STATUS_API_TO_UI[video.status] ?? "Brouillon",
//         videoType:   "Interview",
//         publishDate: "",
//         tags:        [],
...
//         if (!label || form.tags.find((t) => t.label === label)) return;
//         const color =
//         TAG_COLORS_MAP[label] ??
//         `#${Math.floor(Math.random() * 0xffffff).toString(16).padStart(6, "0")}`;
//         update("tags", [...form.tags, { id: Date.now().toString(), label, color }]);
//         setTagInput("");
//     };

//     const removeTag = (id: string) =>
//         update("tags", form.tags.filter((t) => t.id !== id));
...
//             status: apiStatus,
//             content: [{ type: "text", value: form.description.trim() || "Contenu vide" }],
//         };
...
//         if (form.videoType)              payload.videoType       = form.videoType;
...
//                 Vidéo #{video.id} · Modifié le {new Date(video.updatedAt).toLocaleDateString("fr-FR")}
//             </p>
//             </div>
...
//                     Aperçu de la Vidéo
//                 </h2>
//                 <div className="relative rounded-2xl overflow-hidden bg-slate-900 aspect-video group cursor-pointer shadow-xl shadow-slate-300/40">
//                     <div className="absolute inset-0 flex flex-col items-center justify-center gap-3">
//                     <div className="w-14 h-14 rounded-full bg-white/10 border-2 border-white/30 flex items-center justify-center group-hover:scale-110 transition-transform backdrop-blur-sm">
//                         <Play className="w-6 h-6 text-white fill-white ml-0.5" />
//                     </div>
//                     <p className="text-white/60 text-xs font-medium">Aperçu de la vidéo</p>
//                     <p className="text-white/40 text-xs truncate max-w-xs px-4">{form.sourceUrl}</p>
//                     </div>
//                     {form.duration && (
//                     <div className="absolute bottom-3 right-3 bg-black/50 text-white text-xs px-2 py-1 rounded-lg backdrop-blur-sm font-mono">
//                         {form.duration}
//                     </div>
//                     )}
//                 </div>
...
//                     <FieldLabel>
//                     URL Source <span className="text-slate-400 normal-case font-normal">(YouTube / Vimeo)</span>
//                     </FieldLabel>
//                     <input
//                     type="url"
...
//                     className="w-full bg-white border border-slate-200 rounded-xl px-4 py-2.5 text-sm text-slate-700 font-mono focus:outline-none focus:ring-2 focus:ring-orange-400 focus:border-transparent transition"
//                     />
//                 </div>
//                 </section>
...
//                     <FieldLabel>
//                     Description{" "}
//                     <span className="text-slate-400 normal-case font-normal">(résumé SEO)</span>
//                     </FieldLabel>
//                     <textarea
...
//                     Miniature
//                 </h2>
//                 <div className="relative rounded-2xl overflow-hidden aspect-video bg-lineair-to-br from-orange-400 to-rose-500 shadow-lg">
...
//                     </div>
//                 </div>
//                 <button className="mt-3 w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-orange-500 text-white text-sm font-semibold hover:bg-orange-600 transition shadow-md shadow-orange-200">
...
//                         className="flex-1 bg-white border border-slate-200 rounded-xl px-3 py-2 text-xs text-slate-700 shadow-sm focus:outline-none focus:ring-2 focus:ring-orange-400 transition"
//                     />
//                     <button
//                         onClick={addTag}
//                         className="p-2 rounded-xl bg-orange-50 border border-orange-200 text-orange-500 hover:bg-orange-100 transition"
//                     >
