...
// import NewStaticPageModal from "./Newstaticpagemodal";
// import StaticPageEditor from "./StaticpageEdit";
...
//         });
//         } catch (err: unknown) {
//         setError((err as Error).message || "Erreur lors du chargement des pages");
//         } finally {
//         setLoading(false);
//         }
...
//     useEffect(() => {
//         loadPages();
//     }, [currentPage, filterStatut, loadPages]);
...
//         }
//         } catch (err: unknown) {
//         alert((err as Error).message || "Impossible de supprimer la page");
//         } finally {
//         setDeletingId(null);
//         }
//     };
...
//             {error}
//             <button onClick={loadPages} className="ml-auto underline text-red-600 hover:text-red-800">
//                 Réessayer
//             </button>
//             </div>
//         )}
...
//                             style={{
//                             backgroundColor: `${page.category.color}15`,
//                             color: page.category.color,
//                             borderColor: `${page.category.color}40`,
//                             }}
//                         >
//                             {page.category.name}
//                         </span>
//                         </td>
//                         <td className="px-4 py-4 text-center text-slate-600">{page.author.name}</td>
//                         <td className="px-4 py-4 text-center text-slate-500">{formatDate(page.updatedAt)}</td>
//                         <td className="px-4 py-4 text-center">
