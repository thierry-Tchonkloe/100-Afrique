...
//         </div>
//         <h3 className="text-lg font-semibold text-gray-900 mb-1">Supprimer la destination</h3>
//         <p className="text-sm text-gray-500 mb-6">
//           Voulez-vous vraiment supprimer{" "}
//           <span className="font-medium text-gray-700"> {item.title} </span> ? Cette action est irréversible.
//         </p>
...
//       });
//     } catch (err: unknown) {
//       setError((err as Error).message || "Erreur lors du chargement des destinations");
//     } finally {
//       setLoading(false);
//     }
...
//   }, [search, loadDestinations]);

//   useEffect(() => {
//     loadDestinations();
//   }, [currentPage, filterStatut, loadDestinations]);
...
//       }
//     } catch (err: unknown) {
//       alert((err as Error).message || "Impossible de supprimer la destination");
//     } finally {
//       setDeletingId(null);
//     }
//   };
...
//           {error}
//           <button onClick={loadDestinations} className="ml-auto underline text-red-600 hover:text-red-800">
//             Réessayer
//           </button>
//         </div>
//       )}
...
//                         {dest.coverImage && (
//                           <img src={dest.coverImage} alt={dest.title} className="w-12 h-12 rounded-xl object-cover shrink-0 shadow-sm"/>
//                         )}
//                         <div>
...
//                         style={{
//                           backgroundColor: `${dest.category.color}15`,
//                           color: dest.category.color,
//                           borderColor: `${dest.category.color}40`,
//                         }}
//                       >
//                         {dest.category.name}
//                       </span>
...
//                         <div className="w-7 h-7 rounded-full bg-linear-to-br from-orange-400 to-pink-500 flex items-center justify-center text-white text-xs font-bold shrink-0">
//                           {dest.author.name.charAt(0)}
//                         </div>
//                         <span className="text-slate-600">{dest.author.name}</span>
//                       </div>
//                     </td>
//                     <td className="px-4 py-4 text-center text-slate-500">{formatDate(dest.updatedAt)}</td>
//                     <td className="px-4 py-4 text-center">
