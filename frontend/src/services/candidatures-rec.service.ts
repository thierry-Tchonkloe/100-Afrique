...
// export async function fetchCandidaturesRec(offerId?: string): Promise<CandidaturesRecResponse> {
//   const { data } = await api.get<{ success: boolean; data: CandidaturesRecResponse }>('/candidatures', {
//     params: { offerId },
//   });
//   return data.data ?? (data as unknown as CandidaturesRecResponse);
// }

// export async function updateCandidatureStatus(
//   id: string, status: CandidatureRecStatus
// ): Promise<CandidatureRec> {
//   const { data } = await api.patch<{ success: boolean; data: CandidatureRec }>(
//     `/candidatures/${id}/status`, { status }
//   );
//   return data.data ?? (data as unknown as CandidatureRec);
// }
