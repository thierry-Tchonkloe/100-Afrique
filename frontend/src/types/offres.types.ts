...
// FIX : SECTORS n'est plus une liste inventée localement — elle vient de
// la source unique src/lib/sectors.ts, partagée avec vitrine.types.ts et
// avec le mapping backend src/utils/sectors.ts (voir ce fichier pour le détail).
export const SECTORS = SECTOR_LABELS;
